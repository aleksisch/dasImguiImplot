# -*- coding: utf-8 -*-
#
# dasImguiImplot documentation build configuration file.
#
...
project = u'dasImguiImplot documentation'
...
# Intermediate files used by implot2rst — not standalone documentation pages.
